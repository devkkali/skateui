...
function MembershipUsers() {
    const [document_title, setDoucmentTitle] = useDocumentTitle("View Membership Users");
    ...
    const Reload = (selectedItem) => {
        ...
        axios.get(requests.membership_user, {
            headers: {
    ...
    const TakenItems = (props) => {
        const { sn, id, cost, membership_type, starting_date, end_date, paid } = props;
                ...
                <div className="card shadow-sm bg-light-100s mb-4">
                    <div className="card-header bg-white d-flex justify-content-between">
                        <div>
                            ...
                            <b>{membership_type? membership_type.type_name : null}</b>
                        </div>
                        <div>
                    ...
                    <div className="card-body">
                        <div className="row">
                            ...
                            <div className="col">
                                <div className="row text-end">
                                    <div className="col fw-light text-muted pe-2">Charge/Hr :</div>
                        ...
                        <div className="d-flex mt-3 justify-content-between">
                            ...
                            {(LengthOfItem - 1) === sn ? (
                                <>
                                    <button onClick={() => { OnAddPaymentClick(id, paid) }} className="btn btn-sm btn-success text-white">Edit Charge/Hr</button>
                                </>
                            ) : (
                                <>
                                </>
    ...
    const OnUpdateDetailsClick = () => {
        ...
        axios.put(requests.membership_user + "/" + SelectedItem, { name: NameInput, phone_no: PhoneInput }, {
            headers: {
                Accept: 'application/json',
                Authorization: 'Bearer ' + { token: localStorage.getItem('token') }.token,
                'Content-Type': 'application/json',
    ...
    const OnDeleteDetailClick = () => {
        ...
        setLoadingListDetails(true);
        axios.delete(requests.membership_user + "/" + SelectedItem, {
            headers: {
                Accept: 'application/json',
                Authorization: 'Bearer ' + { token: localStorage.getItem('token') }.token,
                'Content-Type': 'application/json',
    ...
    const OnTakenPackageDelete = (id) => {
        ...
        axios.delete(requests.membership_taken + "/" + id,{
            headers: {
                Accept: 'application/json',
                Authorization: 'Bearer ' + { token: localStorage.getItem('token') }.token,
                'Content-Type': 'application/json',
                    ...
                    <div className="d-flex h-100 align-items-stretch">
                        <div className="col d-flex flex-column">
                            <div className="p-3 bg-white rounded">
                                <p className="page-title  mb-3">Membership List</p>
                                        ...
                                        <>
                                            <div className=" p-3 rounded h-inherit overflow-auto">
                                                ...
                                                <div className="mt-2">
                                                    ...
                                                    {LoadingListDetails ? (<>Loading...</>) : (
                                                        <>
                                                            {SelectedItemDetails['membership_taken'].map((filteredList, i) => (
