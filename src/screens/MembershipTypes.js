...
function MembershipTypes() {
    const [document_title, setDoucmentTitle] = useDocumentTitle("Membership Type Setting");
    ...
    const OnUpdateDetailsClick = () => {
        ...
        axios.put(requests.membership_type + "/" + SelectedItem, { type_name: NameInput, validity_in_day: ValidityInput, cost: CostInput }, {
            headers: {
                Accept: 'application/json',
                Authorization: 'Bearer ' + { token: localStorage.getItem('token') }.token,
                'Content-Type': 'application/json',
    ...
    const OnAddNewClick = () => {
        ...
        axios.post(requests.membership_type , { type_name: NameInput, validity_in_day: ValidityInput, cost: CostInput }, {
            headers: {
                Accept: 'application/json',
                Authorization: 'Bearer ' + { token: localStorage.getItem('token') }.token,
                'Content-Type': 'application/json',
    ...
    const OnDeleteDetailClick = () => {
        ...
        setLoadingListDetails(true);
        axios.delete(requests.membership_type + "/" + SelectedItem, {
            headers: {
                Accept: 'application/json',
                Authorization: 'Bearer ' + { token: localStorage.getItem('token') }.token,
                'Content-Type': 'application/json',
                    ...
                    <div className="d-flex h-100 align-items-stretch">
                        <div className="col d-flex flex-column">
                            <div className="p-3 bg-white rounded">
                                <p className="page-title  mb-3">Membership Types</p>
                                ...
                                {SelectedItemDetails ? (
                                    <>
                                        <div className=" p-3 rounded h-inherit overflow-auto">
                                            <p className="page-title">Edit Membership Type</p>
                                    ...
                                    <>
                                        <div className="">
                                            <div className=" p-3 rounded h-inherit overflow-auto">
                                                <p className="page-title">Add New Membership Type</p>
                                                <div className="bg-white border p-4 position-relative rounded">
                                                    <div className="row mb-3 mt-2">
                                                        <label className="col-sm-2 col-form-label">Type Name</label>
                                                        <div className="col-sm-10">
