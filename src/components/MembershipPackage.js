...
function MembershipPackage() {
    ...
    const SubmitClicked = (event) => {
        ...
        axios.post(requests.package_user, { package_type_id: OptionSelected, card_id: CardNumber, name: Name, phone_no: Phone, paid: Amount }, {
            headers: {
                Accept: 'application/json',
                Authorization: 'Bearer ' + { token: localStorage.getItem('token') }.token,
                'Content-Type': 'application/json',
    ...
    return (<>
...

        {
            LoadingApi ? (
                ...
                <>
                    <div id="pak" className="bg-white p-4 border">
                        <form onSubmit={SubmitClicked}>
                            <div className="row mt-3">
                                ...
                                <div className="col-6 d-flex mb-3">
                                    <div className="w-50">
                                        <label htmlFor="card_type" className="form-label">Package Type</label>
                                        {MemberhsipTypes ? (
                                            <>
                                    ...
                                    <div className="w-50 ms-3">
                                        ...
                                        <input onChange={changeAmount} value={Amount} required placeholder="Enter payment amount" type="text" id="payment" name="payment" className="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div className="row mt-3">
                            ...
                            <div className="text-end mt-3">
                                <button className="btn btn-success text-white px-3">Submit</button>
                            </div>
                        </form>
                    </div>
                </>
